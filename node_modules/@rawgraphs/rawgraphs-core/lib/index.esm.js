...
function deserializeProject$1(project, charts) {
  ...
  return {
    ...
    userData: matrixToObjects(getOrError$1(project, "rawData"), Object.keys(getOrError$1(project, "dataTypes"))),
...
var VERSION$2 = "1.2";
function serializeProject$2(_ref) {
  var userInput = _ref.userInput,
      userData = _ref.userData,
      userDataType = _ref.userDataType,
      parseError = _ref.parseError,
...
function getOrError$2(object, path) {
  if (!has_1(object, path)) {
    console.log("IMPORT ERROR", object, path);
    throw new Error("Selected project is not valid");
  }
...
function deserializeProject$2(project, defaultCharts) {
  if (project.version !== VERSION$2) {
    throw new Error("Invalid version number, please use a suitable deserializer");
  }

  var chartId = getOrError$2(project, "chart");
  var chart = defaultCharts.find(function (c) {
    return c.metadata.id === chartId;
  });
  ...
  if (!chart) {
    ...
    chart = {
      ...
      rawCustomChart: project.customChart
    };
  }

  return {
    userInput: getOrError$2(project, "userInput"),
    userData: matrixToObjects(getOrError$2(project, "rawData"), Object.keys(getOrError$2(project, "dataTypes"))),
    userDataType: getOrError$2(project, "userInputFormat"),
    parseError: getOrError$2(project, "parseError"),
    unstackedData: getOrError$2(project, "parseOptions.unstackedData"),
    unstackedColumns: getOrError$2(project, "parseOptions.unstackedColumns"),
    dataTypes: getOrError$2(project, "dataTypes"),
    separator: getOrError$2(project, "parseOptions.separator"),
    thousandsSeparator: getOrError$2(project, "parseOptions.thousandsSeparator"),
    decimalsSeparator: getOrError$2(project, "parseOptions.decimalsSeparator"),
    locale: getOrError$2(project, "parseOptions.locale"),
    stackDimension: get_1(project, "parseOptions.stackDimension", undefined),
    dataSource: getOrError$2(project, "dataSource"),
    currentChart: chart,
    mapping: getOrError$2(project, "mapping"),
    visualOptions: getOrError$2(project, "visualOptions")
  };
}

var V1_2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  VERSION: VERSION$2,
  serializeProject: serializeProject$2,
  deserializeProject: deserializeProject$2
});

var DESERIALIZERS = keyBy_1([V1, V1_1, V1_2], "VERSION");
/**
...
function serializeProject$3(project, version) {
  if (version === void 0) {
    version = "latest";
  }

  var defaultSerializer = version === "latest" ? DESERIALIZERS[VERSION$2].serializeProject : function () {
...
function deserializeProject$3(serializedProject, charts) {
  try {
...
export { NumberParser, arrayGetter, baseOptions, chart, colorPresets, dateFormats, deserializeProject$3 as deserializeProject, getAggregator, getAggregatorNames, getAvailableScaleTypes, getColorDomain, getColorScale, getContainerOptions, getDefaultColorScale, getDefaultDimensionAggregation, getDefaultOptionsValues, getDimensionAggregator, getEnabledOptions, getInitialScaleValues, getOptionsConfig, getPresetScale, getTypeName, getValueType, inferTypes, labelsOcclusion, legend, makeMapper, overrideBaseOptions, parseDataset, registerAggregation, registerSerializerDeserializer, serializeProject$3 as serializeProject, translateDateFormat, unregisterAggregation, validateMapperDefinition, validateMapping };
